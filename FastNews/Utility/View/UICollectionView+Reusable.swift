...
public extension UICollectionView {
    ...
    /**
     ...
     - parameter cellType: `UICollectionViewCell` (`Reusable` & `Nibloadable` -conforming) subclass
     to register
     
     - seealso: `regisgter (_: , forCellWithReuseIdentifier:)`
    ...
    /**
     Register a Class-based `UICollectionView` subclass (conforming to `Reusable`)
    ...
    /**
     ...
     - parameter cellType: The cell clas to dequeue
    ...
    /**
     Register a NIB-Based `UICollectionViewReusableView` subclass (conforming to `Reusable` & `NibLoadable`) as a Supplementary View
     
     - parameter supplementaryViewType: the `UIView` (`Reusable` & `NibLodable`-conforming) subclass to register as Supplementary View
     - parameter elementKind : The kind of the supplementary view to create
    ...
    /**
     ...
     - parameter supplementaryViewType: the `UIView` (`Reusable`-conforming) subclass to register as a Supplementary View
    ...
    /**
     ...
     - note: The `viewType` parameter can generally be omitted and inferred by the return type, except when your type is in a variable and cannot be determined at compile time
